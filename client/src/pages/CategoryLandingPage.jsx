...
const CategoryLandingPage = ({ category, initialSubcategories }) => {
    ...
    const handleAddToCart = (e, product, index) => {
        e.stopPropagation();
        addToCart({
            id: product._id,
            name: product.name,
                        ...
                        >
                            <div className="collection-card-media">
                                ...
                                <div className="collection-card-actions">
                                    <button type="button" onClick={(e) => handleAddToCart(e, product, index)} aria-label={`Add ${product.name} to bag`}>
                                        <FaShoppingBag />
                                        <span>Add</span>
                                    </button>
                                    <button type="button" onClick={(e) => handleWishlist(e, product, index)} aria-label={`Save ${product.name}`}>
                                        <FaHeart />
                                    </button>
                                </div>
                            </div>
